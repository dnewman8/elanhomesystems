...
/**
 * @file
 * All the brand websites share this settings file.
 */

define('COREBRANDS_DOMAIN', 'gefen.com');
define('COREBRANDS_BRAND', 'Gefen');

define('NETSUITE_BRAND', 26);
define('NETSUITE_RESOURCE_BRAND', 23);
