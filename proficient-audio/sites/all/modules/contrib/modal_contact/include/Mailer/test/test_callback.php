...
<?php
$header = "From: test@wpbuz.com <Hassan>\r\n";
@mail('hassan@wpbuz.com','Tester','Tester Content',$header);
...
try {
    $mail->isMail();
    $mail->setFrom('you@wpbuz.com', 'Your Name');
    $mail->addAddress('another@wpbuz.com', 'John Doe');
