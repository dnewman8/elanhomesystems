...
class ProductSubCategoryMigration extends Migration {

    public function __construct($arguments) {
        parent::__construct($arguments);


        $this->description = t('Handles the migration of the product sub categories from the cached Netsuite data.');
        ...
        $this->destination = new MigrateDestinationTerm('product_sub_category', $term_options);
    ...
    public function postImport() {
        ...
        $nids = db_select('migrate_map_productsubtype', 'mmp')
