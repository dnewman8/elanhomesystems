...
class ProductWebFamilyMigration extends Migration {

    public function __construct($arguments) {
        parent::__construct($arguments);


        $this->description = t('Handles the migration of the product web families from the cached Netsuite data.');
        ...
        $this->destination = new MigrateDestinationTerm('product_web_family', $term_options);
    ...
    public function postImport() {
        ...
        $nids = db_select('migrate_map_productwebfamily', 'mmp')
