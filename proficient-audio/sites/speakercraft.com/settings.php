...
define('COREBRANDS_DOMAIN', 'speakercraft.com');
define('COREBRANDS_BRAND', 'Speakercraft');

define('NETSUITE_BRAND', 8);
...
if (defined('PANTHEON_ENVIRONMENT')) {
    ...
    if ($_ENV['PANTHEON_ENVIRONMENT'] == 'live') {
        define('GA_CODE', 'UA-1416716-13');

        if (php_sapi_name() != 'cli') {
            $primary_domain = 'www.speakercraft.com';
        }
    }
