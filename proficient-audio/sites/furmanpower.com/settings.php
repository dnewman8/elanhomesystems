...
define('COREBRANDS_DOMAIN', 'furmanpower.com');
define('COREBRANDS_BRAND', 'Furman Power');

define('NETSUITE_BRAND', 4);
define('NETSUITE_RESOURCE_BRAND', 22);
